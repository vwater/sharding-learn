/*
 ...
 Source Schema         : archive_order_2023

 Target Server Type    : MySQL
 Target Server Version : 80100
 File Encoding         : 65001

 Date: 27/02/2024 22:24:50
*/
...
-- ----------------------------
BEGIN;
INSERT INTO `order_header_0` (`id`, `tenant_id`, `create_time`, `update_time`, `create_by`, `update_by`, `migrate_tag`) VALUES (0, 0, '2024-02-04 07:31:11', '2024-02-26 07:25:06', 'vwater1', 'vwater1', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `order_header_1` (`id`, `tenant_id`, `create_time`, `update_time`, `create_by`, `update_by`, `migrate_tag`) VALUES (1, 1, '2024-02-04 07:31:20', '2024-02-26 10:04:48', 'vwater2', 'vwater2', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `order_header_3` (`id`, `tenant_id`, `create_time`, `update_time`, `create_by`, `update_by`, `migrate_tag`) VALUES (3, 3, '2024-02-04 07:31:20', '2024-02-26 10:06:45', 'vwater2', 'vwater2', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `order_item_1` (`id`, `tenant_id`, `order_id`) VALUES (1, 1, 1);
COMMIT;
